...
partial class BugReportList
{
    ...
    private void InitializeComponent()
    {
        ...
        FilterBox.Items.AddRange(new object[] { "All", "System", "Apps", "Opened", "Closed", "With user data", "No user data" });
        ...
        GridView.Columns.AddRange(new DataGridViewColumn[] { Icon, Timestamp, Title, Author, Opened, UserData });
